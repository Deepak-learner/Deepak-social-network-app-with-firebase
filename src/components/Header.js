...
function Header() {
  const user = JSON.parse(localStorage.getItem("deepak-social-network-app-user"));
    ...
    <div className="p-3 bg-primary rounded-md">
      ...
      <div className="flex items-center justify-between">
        <div onClick={() => navigate("/")} className="cursor-pointer">
          <h1 className="text-2xl font-semibold text-white">Deepak Social Network App</h1>
        ...
        <div className="flex space-x-10 justify-end items-center md:hidden">
          ...
          <h1
            ...
            onClick={() => {
              localStorage.removeItem("deepak-social-network-app-user");
              navigate("/login");
            }}
          >
            Logout
